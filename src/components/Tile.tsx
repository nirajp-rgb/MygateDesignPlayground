  ...
  return (
    ...
    >
      ...
      <View style={{ alignSelf: 'stretch', alignItems: 'center', gap: 2 }}>
        {sublabel ? (
          <Text style={[typography.bodyDefaultBold, { color: colors.contentPrimary, textAlign: 'center' }]}>
            {sublabel}
          </Text>
        ) : null}
        <Text
          numberOfLines={2}
          style={[typography.bodySmallBold, { color: colors.contentPrimary, textAlign: 'center' }]}
        >
          {label}
        </Text>
      </View>
